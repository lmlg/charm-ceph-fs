    ...
    def test_hooks(self):
        ...
        hook_set = {
            'when': {
                ...
                'cephfs_share_available': ('cephfs.configured', 'ceph-mds.pools.available', 'cephfs-share.available')
            },
            'when_none': {
                'config_changed': ('charm.paused',
                                   'run-default-update-status',),
                'cephfs_share_available': ('charm.paused', 'run-default-update-status'),
            },
        }
...
class TestCephFSHandlers(test_utils.PatchHelper):
    ...
    def test_cephfs_share_available(self):
        ...
        ceph_mds.mon_hosts.return_value = ["10.5.0.80:6789", "10.5.2.23:6789", "10.5.2.17:6789"]
        ceph_mds.all_joined_units.received = {
            "auth":                   "cephx",
            "broker-rsp-ceph-fs-0":   {"exit-code": 0, "key": "AQDvOE5mUfBIKxAAYT73/v7NzwWx2ovLB4nnOg==",
            ...
            "juju-2ffa43-1_mds_key":  "AQDwOE5mmkQ1LBAAVrx4OXWwWM+XmK/KjnJcdA==",
        }
