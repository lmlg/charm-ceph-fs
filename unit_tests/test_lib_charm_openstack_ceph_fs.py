...
class TestCephFsCharm(test_utils.PatchHelper):
    ...
    def test_configuration_class(self):
        ...
        self.patch_object(ceph_fs.reactive.ceph_fs, 'get_networks')
        ...
        self.patch_object(ceph_fs.reactive.ceph_fs, 'get_ipv6_addr')
        self.get_ipv6_addr.return_value = ['2001:db8::fake']
        self.patch_object(ceph_fs.reactive.ceph_fs, 'get_public_addr')
